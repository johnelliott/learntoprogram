def seconds_difference(time_1, time_2):
    ...
    0.0
    """
    return time_2 - time_1 #this works
...
def hours_difference(time_1, time_2):
    ...
    return seconds_difference(time_1,time_2)/3600 #this works
...
def to_float_hours(hours, minutes, seconds):
    ...
    return hours + minutes/60 + seconds/3600 #this works
...
def get_minutes(seconds):
    ...
    3
    """
    return seconds%3600//60 #this works
...
def time_to_utc(utc_offset, time):
    ...
    #Test Statement: print(time_to_utc(+0, 12.0), time_to_utc(+1, 12.0), time_to_utc(-1, 12.0), time_to_utc(-11, 18.0), time_to_utc(-1, 0.0), time_to_utc(-1, 23.0))
    #All tests work
...
def time_from_utc(utc_offset, time):
    ...
    """
    return (time + utc_offset)%24
    #Test Statement: print(time_from_utc(+0, 12.0), time_from_utc(+1, 12.0), time_from_utc(-1, 12.0), time_from_utc(+6, 6.0), time_from_utc(-7, 6.0), time_from_utc(-1, 0.0), time_from_utc(-1, 23.0), time_from_utc(+1, 23.0))
    #All tests work
